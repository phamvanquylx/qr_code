					...
					<div class="col-xs-12 col-sm-8">
						<div id="qr-generator">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a><span class="glyphicon glyphicon-envelope"></span> Email</a></li>
							...
							<div class="tab-content">
								<div id="menu1" class="tab-pane in active">
									...
									<form>
									  ...
									  <fieldset class="qr-input-sms qr-input--email">
									    <legend>Email: </legend>
									    <input type="text" name="email" placeholder="Your Email" required>
									  </fieldset>
									  <fieldset class="qr-input-sms qr-input--subject">
									    <legend>Subject: </legend>
									    <input type="text" name="subject" placeholder="Product Request" required>
									  </fieldset>									  
									  <fieldset class="qr-input-sms qr-input--message">
									    <legend>Message: </legend>
									    <textarea type="text" name="message" placeholder="Enter your text here" required></textarea>
									  </fieldset>									  
									  <button type="button" class="qr-submit-form qr-submit-form--email"><span class="glyphicon glyphicon-refresh"></span>Create QR Code</button>
