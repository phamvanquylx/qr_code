					...
					<div class="col-xs-12 col-sm-8">
						<div id="qr-generator">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a><span class="glyphicon glyphicon-pencil"></span> SMS</a></li>
							...
							<div class="tab-content">
								<div id="menu1" class="tab-pane in active">
									...
									<form>
									  ...
									  <button type="button" class="qr-submit-form qr-submit-form--sms"><span class="glyphicon glyphicon-refresh"></span>Create QR Code</button>
