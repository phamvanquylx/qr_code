					...
					<div class="col-xs-12 col-sm-8">
						<div id="qr-generator">
							<ul class="nav nav-tabs">
								<li class="active"><a><span class="glyphicon glyphicon-link"></span> Url</a></li>
							...
							<div class="tab-content">
								<div id="menu1" class="tab-pane in active">
									<h3 class="qr-coming">Website (URL)</h3>
									<form>
									  <fieldset>
									    <legend>Size:</legend>
									  ...
									  <fieldset class="qr-input-sms">
									    <legend>URL link</legend>
									    <input type="text" name="content" class="qr-content" placeholder=" https://www.example.de" required>
									  </fieldset>		  
									  <button type="button" class="qr-submit-form qr-submit-form--url"><span class="glyphicon glyphicon-refresh"></span>Create QR Code</button>
