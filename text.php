					...
					<div class="col-xs-12 col-sm-8">
						<div id="qr-generator">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a><span class="glyphicon glyphicon-align-left"></span> Text</a></li>
								...
								<div id="menu1" class="tab-pane in active">
									...
									<form>
									  ...
									  <fieldset class="qr-input-sms qr-input-sms--message">
									    ...
									    <textarea type="text" name="message" class="qr-content" placeholder=" Enter your text here" required></textarea>
									  </fieldset>									  
									  <button type="button" class="qr-submit-form qr-submit-form--text"><span class="glyphicon glyphicon-refresh"></span>Create QR Code</button>
